...
Данный документ содержит визуальное представление всех эндпоинтов API. Используйте приведенные ниже изображения для быстрого ознакомления с форматами данных и функциональностью сервиса.
