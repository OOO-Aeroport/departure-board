...
Данный документ содержит визуальное представление всех эндпоинтов API. Используйте изображения для быстрого ознакомления с форматами данных и функциональностью API.
